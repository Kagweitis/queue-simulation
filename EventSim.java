...
public class EventSim
{
    ...
    private static PrintWriter input, output; 
    ...
    {
    	// creating input file and writing input parameters
    	PrintWriter input = new PrintWriter("infile.txt");
        input.printf("%.1f %.1f %d", 1.0, 0.5, 1000);
        input.close();
